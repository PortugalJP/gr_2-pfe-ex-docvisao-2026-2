...
- Morador — Adquirir produtos/serviços sem se deslocar fisicamente. (Prioridade: Alta)
- Morador — Acompanhar o status do pedido em tempo real. (Prioridade: Alta)
- Comerciante — Ter um canal de venda digital acessível e simples. (Prioridade: Alta)
- Comerciante — Gerenciar pedidos e disponibilidade de produtos. (Prioridade: Média)
- Entregador — Ter acesso fácil a oportunidades de entrega na região. (Prioridade: Alta)
- Entregador — Receber pagamento de forma confiável. (Prioridade: Alta)
...
[3. Descição de Stakeholders e Usuáios](#3-descrição-de-stakeholders-e-usuários)

[3.1 Resuo dos Stakeholders](#31-resumo-dos-stakeholders)
